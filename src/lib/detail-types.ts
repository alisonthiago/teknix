...
export interface ProductDetail {
  ...
  marketplaces: Array<{ name: string; listing_id: string; price: number; stock: number; status: 'ACTIVE' | 'INACTIVE'; last_sync: string }>
  recent_sales: Array<{ id: string; order_id: string; marketplace: string; quantity: number; price: number; revenue: number; profit: number; margin: number; status: string; date: string }>
