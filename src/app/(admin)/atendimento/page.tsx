...
export default function AtendimentoChatPage() {
  ...
  const handleSendMessage = async (textToSend?: string) => {
    ...
    try {
      ...
      notify({
        ...
        message: 'Entregue com sucesso no chat do Mercado Livre.'
      })
  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-200">
      ...
      <div className="bg-white rounded-2xl border border-[#e6e6e6] px-5 py-3.5 shadow-xs flex items-center justify-between">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-[17px] font-black text-[#1f2328] tracking-tight">
                Mensagens de Venda & Chat ao Vivo
              </h1>
            ...
            <p className="text-[11px] text-[#666]">
              Converse diretamente com seus compradores de todos os marketplaces em um só lugar.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={refreshing}
            className="px-3.5 py-2 rounded-xl text-[12px] font-bold border border-[#e6e6e6] bg-[#f8f9fa] hover:bg-[#f0f0f0] text-[#333] flex items-center gap-1.5 transition-colors cursor-pointer disabled:opacity-50"
          >
      ...
      {/* 💬 INTERFACE PRINCIPAL DO CHAT ESTILO OMNICHANNEL */}
