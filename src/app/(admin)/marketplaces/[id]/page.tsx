          ...
          <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl p-6 border border-[#e6e6e6]">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-[#999]">{disconnectingAccount.account_name}</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-2.5">
              <button
                ...
                className="px-4 py-2 text-sm font-semibold text-[#666] hover:bg-[#f5f5f5] rounded-xl transition-colors cursor-pointer"
              >
                Cancelar
              </button>
              <button
                ...
                disabled={isDisconnecting}
                className="px-4 py-2 bg-[#e74c3c] hover:bg-[#c0392b] text-white text-sm font-bold rounded-xl transition-colors shadow-sm disabled:opacity-50 flex items-center gap-1.5 cursor-pointer"
              >
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#666]">Sincronização em tempo real de vendas e anúncios</p>
                </div>
              </div>
              <button
                type="button"
            ...
            <form onSubmit={handleSaveTokenSubmit} className="space-y-3.5">
              ...
              <div className="flex items-center justify-end gap-2.5 pt-2">
                <button
                  ...
                  className="px-4 py-2.5 text-sm font-semibold text-[#666] hover:bg-[#f5f5f5] rounded-xl transition-colors cursor-pointer"
                >
                  Cancelar
                </button>
                <button
      ...
      {!loading && !error && (
        <div className="mt-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-xs text-[#999]">Sincronização de anúncios, estoque e pedidos em tempo real</span>
          </div>
                ...
                return (
                  ...
                  >
                    <div>
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-[#999]">Seller ID: <strong className="text-[#666]">{account.seller_id || 'Principal'}</strong></p>
                          </div>
                        </div>
                      ...
                      {/* Info & Sync Details */}
                      <div className="p-3 bg-[#f8f9fa] rounded-xl border border-[#eeeeee] space-y-1.5 text-xs text-[#666] mb-4">
                    ...
                    <div className="flex flex-wrap items-center justify-between pt-3 border-t border-[#f5f5f5] gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#B5F500] hover:bg-[#a3e600] text-[#111] text-xs font-bold rounded-lg transition-colors cursor-pointer border border-[#a2e000] shadow-2xs"
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#f5f5f5] hover:bg-[#eee] text-[#333] text-xs font-bold rounded-lg transition-colors cursor-pointer border border-[#ddd]"
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-semibold text-[#e74c3c] hover:bg-[#fff5f5] rounded-lg transition-colors border border-[#fed7d7] cursor-pointer"
