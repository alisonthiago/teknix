          ...
          {[
            ...
            <div key={field.label}>
              ...
              <input
                ...
                className={`w-full px-3.5 py-2.5 border border-[#e6e6e6] rounded-xl text-[13px] text-[#333] outline-none focus:border-[#16a34a] transition-colors bg-white ${field.mono ? 'font-mono' : ''}`}
              />
            </div>
          ))}
        </div>
