...
export default function Home() {
  ...
  // Auto-play no carrossel de entretenimento
  useEffect(() => {
    if (!isPlaying) return
  ...
  // Se houver página Home oficial publicada via Page Editor (HUB), renderiza dinamicamente!
  if (publishedHomeId) {
