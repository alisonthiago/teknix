...
export default function BlogAnalytics() {
  ...
  return <div className="blog-tool-page">
    <header style={{ justifyContent: 'flex-end' }}><div><select value={period} onChange={e=>setPeriod(Number(e.target.value))}><option value={7}>7 dias</option><option value={30}>30 dias</option><option value={365}>1 ano</option></select><button onClick={()=>navigate('/hub/blog')}>Voltar ao Blog</button></div></header>
