...
const TeknixLogo = () => (
  <svg id="Camada_2" data-name="Camada 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 113.98 26.81" className="flow-login-logo">
...
export default function Login() {
  ...
  return (
    <div className="flow-login-page">
      {/* Left Column - Form */}
      <div className="flow-login-left">
        {/* Logo Header */}
        <div className="flow-login-header-logo">
          <TeknixLogo />
        </div>
        ...
        <div className="flow-login-form-box">
          ...
          {import.meta.env.VITE_DEMO_MODE === 'true' && (
            <div className="flow-login-demo-notice">
              <strong>DEMO MODE ATIVO</strong><br />
              Email: teste@teste.com • Senha: 123456
            </div>
          )}

          {error && (
            <div className="flow-login-error">
              Erro: {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="flow-login-form">
            <div className="flow-form-fields">
              <div className="flow-form-group">
                <label htmlFor="email" className="flow-form-label">Email</label>
                <input
                  id="email"
                  type="email"
                  value={email}
              ...
              <div className="flow-form-group">
                <div className="flow-label-row">
                  <label htmlFor="password" className="flow-form-label">Senha</label>
                  <a href="#" className="flow-forgot-link">Esqueceu a senha?</a>
                </div>
                <input
                  id="password"
                  type="password"
            ...
            <div className="flow-terms-row">
              <input type="checkbox" id="terms" defaultChecked className="flow-checkbox" />
              <label htmlFor="terms" className="flow-terms-label">
                Eu concordo com os <a href="#" className="flow-terms-link">Termos e Condições</a> e a <a href="#" className="flow-terms-link">Política de Privacidade</a>.
              </label>
            </div>

            <button type="submit" className="flow-login-submit-btn" disabled={loading}>
              {loading ? 'Entrando...' : 'Entrar'}
            </button>

            <p className="flow-signup-text">
              Não tem uma conta? <a href="#" className="flow-signup-link">Cadastre-se</a>
            </p>
          </form>
        </div>
      ...
      {/* Right Column - Graphic (FLOW Lime Glow) */}
