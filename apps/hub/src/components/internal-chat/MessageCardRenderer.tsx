          ...
          <div className="chat-card-box">
            <div className="chat-card-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <ShoppingCart size={16} color="#1f2328" />
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
              ...
              <div style={{ minWidth: 0, display: 'flex', flexDirection: 'column', gap: 3 }}>
                <p style={{ fontWeight: 700, fontSize: '13.5px', color: '#1e293b', margin: 0 }}>
          ...
          <div className="chat-card-box">
            <div className="chat-card-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontWeight: 700, fontSize: '13.5px', color: '#1e293b' }}>Produto Operacional</span>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
              ...
              <div style={{ minWidth: 0, display: 'flex', flexDirection: 'column', gap: 3 }}>
                <p style={{ fontWeight: 700, fontSize: '13.5px', color: '#1e293b', margin: 0 }}>{meta.product_name}</p>
          ...
          <div className="chat-card-box">
            <div className="chat-card-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontWeight: 700, fontSize: '13.5px', color: '#1e293b' }}>Ficha de Cliente</span>
              </div>
            </div>
            <div>
              <p style={{ fontWeight: 800, fontSize: '14px', color: '#1e293b', margin: 0 }}>{meta.customer_name || 'Cliente TEKNIX'}</p>
          ...
          <div className="chat-card-box">
            <div className="chat-card-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontWeight: 700, fontSize: '13.5px', color: '#1e293b' }}>Nota Fiscal Emitida</span>
              </div>
          ...
          <div className="chat-card-box">
            <div className="chat-card-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontWeight: 700, fontSize: '13.5px', color: '#1e293b' }}>Envio & Logística</span>
              </div>
