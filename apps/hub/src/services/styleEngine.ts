...
export function computeSectionStyles(section: any, viewport: ViewportMode = 'desktop'): React.CSSProperties {
  ...
  // Visibility
  const hideDesktop = !!section.hide_on_desktop || !!section.hide_desktop
  const hideTablet = !!section.hide_on_tablet || !!section.hide_tablet
  const hideMobile = !!section.hide_on_mobile || !!section.hide_mobile

  if (viewport === 'desktop' && hideDesktop) s.display = 'none'
  if (viewport === 'tablet' && hideTablet) s.display = 'none'
  if (viewport === 'mobile' && hideMobile) s.display = 'none'
...
export function computeContainerOuterStyles(container: any, viewport: ViewportMode = 'desktop'): React.CSSProperties {
  ...
  // Visibility
  const hideDesktop = !!container.hide_on_desktop || !!container.hide_desktop
  const hideTablet = !!container.hide_on_tablet || !!container.hide_tablet
  const hideMobile = !!container.hide_on_mobile || !!container.hide_mobile
...
export function computeWidgetStyles(widget: any, viewport: ViewportMode = 'desktop'): React.CSSProperties {
  ...
  // Visibility
  const hideDesktop = !!widget.hide_on_desktop || !!widget.hide_desktop
  const hideTablet = !!widget.hide_on_tablet || !!widget.hide_tablet
  const hideMobile = !!widget.hide_on_mobile || !!widget.hide_mobile
