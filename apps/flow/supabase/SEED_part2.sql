-- ============================================================
-- TEKNIX - Seed de Dados Reais (Parte 2 - sem marketplaces, ja inseridos)
...
VALUES
  ...
  ((SELECT id FROM orders WHERE order_number = 'SH-2024-00002'), (SELECT id FROM products WHERE sku = 'PEL002'), 'PEL002', 2, 29.90, 4.20, 11.96, 0, 6.58, 17.16, 57.37, 'CONCLUIDO'),
