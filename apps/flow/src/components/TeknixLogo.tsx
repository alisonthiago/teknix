...
export function TeknixLogo({ className, style, height = 14 }: { className?: string; style?: React.CSSProperties; height?: number | string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 113.98 26.81"
      className={className}
      fill="currentColor"
    ...
    >
      <g fill="currentColor">
        ...
        <g>
          <path d="M111.95,4.58l.05.03c1.07.16,1.87,1.01,1.98,2.06v.46c-.13,1.16-1.09,2.06-2.25,2.09-1.42.04-2.55-1.21-2.35-2.65.17-1.03.95-1.81,1.98-1.96l.03-.02h.57ZM113.51,6.89c0-1.02-.83-1.84-1.84-1.84s-1.84.83-1.84,1.84.83,1.84,1.84,1.84-.83,1.84-1.84Z" />
